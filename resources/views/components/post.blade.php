<span class="border border-4 bg-dark border-dark rounded text-light">
    <div class="col-md-auto">
        <div class="container-fluid p-4">
            ...
            <!-- if post creator specified a League of Legends account,
                a short description will be shown together with his posts -->
            <div class="row mb-3">
            ...
            <div class="clearfix">
                <!-- if an image was uploaded, it will be shown here -->
